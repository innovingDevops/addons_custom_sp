odoo.define('ks_dashboard_ninja_list.ks_image_basic_widget', function (require) {
    ...
    var KsImageWidget = basic_fields.FieldBinaryImage.extend({
        ...
        init: function (parent, state, params) {
            ...
            this.ks_icon_set = ['home', 'puzzle-piece', 'clock-o', 'comments-o', 'car', 'calendar', 'calendar-times-o', 'bar-chart', 'commenting-o', 'star-half-o', 'address-book-o', 'tachometer', 'search', 'money', 'line-chart', 'area-chart', 'pie-chart', 'check-square-o', 'users', 'shopping-cart', 'truck', 'user-circle-o', 'user-plus', 'sun-o', 'paper-plane', 'rss', 'gears', 'check', 'book','usd'];
        },
