...
class DemandeActeCaisse(models.Model):
    _name = "demande.acte.caisse"
    ...
    #         seq = self.env['ir.sequence'].next_by_code('demande.acte.caisse')
    #     return seq
    #===========================================================================
    ...
    date_jour = fields.Date("Date jour", default=lambda self: fields.datetime.now())
    quantity = fields.Integer(string="quantité",  track_visibility="always")
    amount = fields.Float(string="Montant", track_visibility="always")
    demande_acte_caisse_line_ids = fields.One2many('demande.acte.caisse.line', 'demande_acte_caisse_id', string="")
